import {
  Activity, Armchair, ArrowDownToLine, ArrowLeft, ArrowRight, ArrowUp, ArrowUpCircle, ArrowUpRight,
  BadgeCheck, Ban, BellOff, BellRing, Box, Brain, Briefcase, Building, Building2,
  ...
  ChevronsDownUp, Circle, CircleAlert, CircleDot, Clock,
  CloudCheck, CloudOff, CloudUpload, Coins, Construction, Cpu, Crosshair, Download,
  Droplets, Eye, Factory, FileText, FileWarning, Filter, Flag, Flame,
  FlaskConical, Flower, Gauge, Gift, GitBranch, GlassWater, Globe, GraduationCap,
  Hand, HardHat, History, Home, Image, Images, Info, InfoIcon, Landmark, Layers,
  LayoutDashboard, LayoutGrid, Leaf, LocateFixed, Lock, LogOut, Magnet, Mail,
  Map, MapPin, MapPinOff, Medal, Megaphone, Menu, Monitor, MonitorSmartphone,
  MonitorUp, Navigation, NotebookPen, Pencil, Percent, Phone, Play, Plus, Recycle,
  RefreshCw, Repeat, Route, Scale, ScanLine, Scissors, SearchCheck, Settings,
  ShieldCheck, Shirt, SlidersHorizontal, Sun, Sparkles, Sprout, Star, TextCursorInput,
  Thermometer, Ticket, Timer, ToggleLeft, Trash, Trash2, TreePalm, TrendingUp,
  TriangleAlert, Trophy, Truck, Upload, User, UserCircle, UserPlus, Users,
  Warehouse, Wind, Wrench, X, Zap, ZoomIn,
} from 'lucide-react';
