  ...
  return (
    <div className="flex flex-col gap-6">
      <div className="flex flex-col items-center gap-3 py-4">
        <Avatar name={companyName} size="xl" className="w-20 h-20 text-2xl" />
        <div className="text-center">
          <h1 className="font-headline-md text-headline-md text-primary font-bold">{companyName}</h1>
          <p className="text-sm text-on-surface-variant">{user?.email || 'business@wastechakra.com'}</p>
          <span className="inline-flex mt-2 px-2.5 py-1 rounded-full text-xs font-bold bg-secondary-container text-primary uppercase">Business</span>
        </div>
      </div>
